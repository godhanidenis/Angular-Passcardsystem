...
$subject = "ACCESSONE - YOUR ACCESS CODE / VOTRE CODE D'ACCÈS";
$userEmailTo=$data->emailTo;
...
$message .= '<h3>ACCESSONE - YOUR ACCESS CODE / VOTRE CODE D\'ACCÈS</h3>';
...
$message .= "<h3>You can login here / Vous pouvez vous connecter ici: <a href='https://a1admin.kronosun.com/'>CONNECT</a> </h3><br/><br/>";
